...
public class Saal {
     ...
     * @param in_SaalNummer  Die Nummer des Saals (gleichzeitig seine Bezeichnung)
     */
    public Saal(int in_PlaetzeLoge, int in_PlaetzeParkett, boolean in_3D, int in_SaalNummer) {

        plaetzeLoge = in_PlaetzeLoge;
        plaetzeParkett = in_PlaetzeParkett;
        threeD = in_3D;
        saalNummer = in_SaalNummer;
    }
